...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((subcommand) =>
            subcommand
                ...
                .addUserOption((option) => option.setName('target').setDescription('L\'utente da analizzare')),
        )
        .addSubcommand((subcommand) => subcommand.setName('server').setDescription('Info sul server')),
    ...
    async execute(interaction) {
        ...
        if (subcommand === 'user') {
            ...
            await interaction.reply(`Nome Server: ${guild.name}\nMembri totali: ${guild.memberCount}`);
        }
    },
};